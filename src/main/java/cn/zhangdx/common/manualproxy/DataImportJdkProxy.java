...
public class DataImportJdkProxy {
    ...
    public static void main(String[] args) {
        ...
        DataImportService userDataImportService = (DataImportService)Proxy.newProxyInstance(UserDataImportServiceImpl.class.getClassLoader(), UserDataImportServiceImpl.class.getInterfaces(),
                (proxy, method, args1) -> {
